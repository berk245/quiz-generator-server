...
class GeneratedQuestion(BaseModel):
    ...
    question_text: str = Field(description="The question to be added to the quiz. If you can't generate a question from the context, just leave it blank. Do not make up trivia questions.")
    multiple_choices: str = Field(description="A string that includes four, comma separated potential answers to the "
                                              "question. Do not add anything else, such as A,B,C or 1,2,3")
