...
async def generate_questions(request: Request, db: Session):
    ...
    # ToDo Add a check for ensuring the user is authorized to generate questions in this quiz. Ensure quiz ownership!

    if amount is None or quiz_id is None:
    ...
    questions = [
        ...
        },
        {
            ...
            'multiple_choices': 'The Reign of Terror, The Declaration of the Rights of Man, The Storming of the '
                                'Bastille, The Tennis Court Oath',
            'question_type': 'multi'
         },
        {
            'question_id': 3,
